...
describe("movie app", () => {
  ...
  it("should  add classname", () => {
    ...
    cy.get("input#searchText").should("have.value", "test");
  ...
  it("should contain hej in the call", () => {
    ...
    cy.wait("@moviecall").its("request.url").should("contain", "test");
  });
  ...
  it("should give error when input.value<3", () => {
    cy.get("input").type("testande");
    cy.get("input#searchText").should("have.value", "testande");
  ...
  it("should give no result", () => {
    ...
    cy.wait("@moviecall").its("request.url").should("contain", "s=test");
  });
